...
precision <- confusion_matrix$byClass["1","Pos Pred Value"]
recall <- confusion_matrix$byClass["1","Sensitivity"]
accuracy <- confusion_matrix$overall["Accuracy"]
f1_score <- confusion_matrix$byClass["1","F1"]
sensitivity <- confusion_matrix$byClass["1","Sensitivity"]
...
Tendo em conta as métricas analisadas queremos salientar a accuracy com 81,38 %.
